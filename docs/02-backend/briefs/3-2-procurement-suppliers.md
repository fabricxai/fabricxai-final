...
**Department:** DEPT 3b — PROCUREMENT (served by Store dept + Commercial)
**Companions:** `PLAYBOOK.md` (process) · `docs/handoffs/HANDOFF-3-2-procurement-suppliers.md` (final contract, created after design lock) · `CLAUDE.md` (repo rules)
