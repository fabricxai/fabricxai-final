...
**Department:** DEPT 4 — PLANNING & IE
**Companions:** `PLAYBOOK.md` (process) · `docs/handoffs/HANDOFF-4-1-capacity-line-planning.md` (final contract, created after design lock) · `CLAUDE.md` (repo rules)
